...
public class MainMenuView extends GameStateView {
    ...
    public void initialize(Graphics2D graphics) {
        ...
        inputKeyboard.registerCommand(GLFW_KEY_ENTER, true, (double elapsedTime) -> {
            nextGameState = switch (currentSelection) {
                ...
                case MenuState.KeyboardSettings -> GameStateEnum.KeyboardSettings;
    ...
    public void render(double elapsedTime) {
        ...
        top = renderMenuItem(currentSelection == MenuState.KeyboardSettings ? fontSelected : fontMenu, "Keyboard Settings", top, HEIGHT_MENU_ITEM, currentSelection == MenuState.KeyboardSettings ? Color.YELLOW : Color.BLUE);
